...
--
-- Table structure for table `godz_otwarcia`
--

DROP TABLE IF EXISTS `godz_otwarcia`;
...
--
-- Dumping data for table `godz_otwarcia`
--

LOCK TABLES `godz_otwarcia` WRITE;
/*!40000 ALTER TABLE `godz_otwarcia` DISABLE KEYS */;
INSERT INTO `godz_otwarcia` VALUES (1,'poniedziałek','09:00','19:00',0),(2,'wtorek','09:00','19:00',0),(3,'środa','09:00','19:00',0),(4,'czwartek','09:00','19:00',0),(5,'piątek','09:00','19:00',0),(6,'sobota','08:00','16:00',0),(7,'niedziela','00:00','00:00',1);
/*!40000 ALTER TABLE `godz_otwarcia` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `kategorie` VALUES (1,'fryzjer'),(2,'menicure/pedicure'),(3,'makijaż/henna'),(4,'zabiegi');
...
-- Dump completed on 2023-03-08 14:48:20
